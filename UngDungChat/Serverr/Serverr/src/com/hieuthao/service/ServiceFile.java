...
import com.hieuthao.model.Model_File;
import com.hieuthao.model.Model_File_Reicever;
import com.hieuthao.model.Model_File_Sender;
import com.hieuthao.model.Model_Package_Sender;
import com.hieuthao.model.Model_Reicever_Img;
import com.hieuthao.model.Model_Reques_File;
...
public class ServiceFile {
    ...
    public void initFile(Model_File file, Model_Send_Message message) throws IOException {
        fileReceivers.put(file.getFileID(), new Model_File_Reicever(message, toFileObject(file)));
    }
    ...
    public Model_Send_Message closeFile(Model_Reicever_Img dataImage) throws IOException, SQLException {
        Model_File_Reicever file = fileReceivers.get(dataImage.getFileID());
    ...
    private String convertFileToBlurHash(File file, Model_Reicever_Img dataImage) throws IOException {
    ...
    private final Map<Integer, Model_File_Reicever> fileReceivers;
